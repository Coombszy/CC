...
local targetFiles = { "lib/configManager.lua", "lib/utils.lua", "config/patcher.conf", "config/shared.conf",
    "patcher.lua", "config/tunnel.conf", "config/storageLegacy.conf", "config/mining.conf", "config/storageinput.conf",
    "config/storageClient.conf", "config/storageServer.conf" }
