...
local targetFiles = {"lib/configManager.lua", "lib/utils.lua", "config/patcher.conf", "config/shared.conf", "patcher.lua", "config/tunnel.conf", "config/storage.conf", "config/mining.conf", "config/storageinput.conf"}
